export const SectionImage = () => {
  return (
    <div className="flex md:w-1/2 min-h-full relative">
      <img className="w-full h-full object-contain pb-20" src="/images/map-illustration.png" alt="ilustrasi peta mudik" />
      <div className="flex items-center w-full absolute top-10 -ml-3 pr-8">
